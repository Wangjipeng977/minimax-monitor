# Contributing to `minimax-monitor`
...
# 2. Clone your fork
git clone https://github.com/wangjipeng977/minimax-monitor.git
cd minimax-monitor

# 3. Install dependencies (none — pure Node.js stdlib, no npm install needed)

# 4. Run the self-audit to verify quality
python ~/.openclaw/workspace/skills/skill-factory/scripts/audit_skill.py . --hit-score
```
...
git add .
git commit -m "feat(minimax-monitor): add <brief description>"

# 5. Push to your fork
git push origin feat/<your-feature-name>

# 6. Open a Pull Request on GitHub
#    - Title: feat(minimax-monitor): add <brief description>
